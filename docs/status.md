...
### **F-001: 会話データ収集機能** (4/7項目完了)

- [x] 会話録音UI
  - ✅ リアルタイム録音機能（モック）
  - ✅ **録音データインポート機能（mp3/m4a対応）** 🆕 2025/10/17
- [x] 会話履歴表示UI
- [x] 会話分析結果表示UI
- [x] 当事者別分析機能（個別分析のみ）
- [ ] 音声認識API連携（Azure Speech Services）
- [ ] 自然言語処理API連携（OpenAI GPT-4）
- [ ] データベース保存機能

**実装状況**: 
- ✅ フロントエンドUI完成（当事者個別分析機能: 2025/10/16）
- ✅ **mp3/m4aファイルインポート機能追加**: 2025/10/17
  - 外部音声ファイル（mp3/m4a）の読み込み
  - 自動テキスト変換（現在はモック）
  - 既存録音フローと統合
- ⏳ バックエンド未実装
- 📁 ファイル: `components/conversation/`, `app/dashboard/conversation/`
